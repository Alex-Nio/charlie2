...
<template>
  <div
    ...
    :class="{ loading: isTTSActive }"
  >
    <div
      class="reactor-container-inner circle abs-center"
      :class="{ active: isReactorActive }"
    >
      <ul class="marks">
        <li />
        <li />
      ...
      <div class="e7">
        <div class="semi-arc-3 e5-1">
          <div class="semi-arc-3 e5-2">
            <div class="semi-arc-3 e5-3">
              <div class="semi-arc-3 e5-4" />
            </div>
          </div>
        </div>
      </div>
...
<style lang="scss" global>
  ...
  $color1: rgba(2, 255, 255, 0.15);
  $color3: rgba(2, 255, 255, 0.3);
  $cshadow: rgba(2, 254, 255, 0.8);
  ...
  .reactor-container {
    ...
    &.loading {
      ...
      .e5-2 {
        ...
        transition:
          animation-duration 10s ease-in-out,
          color 1s linear;
      }
  ...
  .reactor-container-inner {
    ...
    box-shadow:
      0px 0px 50px 15px $color3,
      inset 0px 0px 50px 15px $color3;
    transform: scale(1);
  ...
  .core-inner {
    ...
    box-shadow:
      0px 0px 7px 5px #6a9494,
      0px 0px 10px 10px #52fefe4f inset;
  }
  ...
  .core-wrapper {
    ...
    box-shadow:
      0px 0px 5px 4px #52fefe,
      0px 0px 6px 2px #52fefe inset;
  }
  ...
  .tunnel {
    ...
    background-color: #ffffff;
    box-shadow:
      0px 0px 5px 1px #52fefe,
      0px 0px 5px 4px #52fefe inset;
  }
  ...
  .marks {
    ...
    li {
      ...
      margin-left: 117.5px;
      margin-top: 113.5px;
      animation: color_ease2 3s infinite ease-in-out;
    }
  }

  @keyframes color_ease2 {
    0% {
  ...
  .reactor-container.active {
    ...
    .core-inner {
      ...
      background-color: #ffffff;
      box-shadow:
        0px 0px 7px 5px #52fefe,
        0px 0px 10px 10px #52fefe inset;
    }
