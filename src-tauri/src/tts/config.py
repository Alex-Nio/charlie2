...
class Config:
    ...
    def arg_parse() -> tuple:
        ...
        parser.add_argument("--text", type=str, default="", help="Text for TTS processing")  # Добавленный аргумент для текста
        ...
        return (
            cmd_opts.text,  # Включите аргумент для текста в возвращаемое значение
            cmd_opts.pycmd,
            cmd_opts.port,
            cmd_opts.colab,
            cmd_opts.noparallel,
